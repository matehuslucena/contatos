...
class ContatosControllerTest < ActionController::TestCase
  ...
  test "should create contato" do
    assert_difference('Contato.count') do
      post :create, contato: { company: @contato.company, email: @contato.email, job_title: @contato.job_title, last_name: @contato.last_name, name: @contato.name, phone: @contato.phone, website: @contato.website }
    end
  ...
  test "should update contato" do
    patch :update, id: @contato, contato: { company: @contato.company, email: @contato.email, job_title: @contato.job_title, last_name: @contato.last_name, name: @contato.name, phone: @contato.phone, website: @contato.website }
    assert_redirected_to contato_path(assigns(:contato))
  end
